...
<body>
    <div class="container-sm">
        <form id='formulario' class="row g-3 ">
            ...
            <label >Tabela Detalhe</label>
            <select id="nome_tabela_detalhe" class="form-select" aria-label="Default select example">
                <option selected>Selecione...</option>
                <?php
    ...
    <script>
        $(document).ready(function() {
            $("#btn_gera_crud").click(function() {
                var dados = 'NOME_TABELA=' + $("#nome_tabela").val()+'&NOME_TABELA_DETALHE=' + $("#nome_tabela_detalhe").val();
                //alert(dados);

                $.post({
                    type: "POST",
                    data: dados,
                    url: "gera_mestre_detalhe_backend.php",
